...
def retrieve_quotes_data(symbol, start_date, end_date, destination_folder):
    ...
    with open(str_full_path, 'w', newline='') as file:
        ...
        first_row = ["timestamp", "sym", "bid_price", "bid_size", "ask_price", "ask_size"]
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 5:
        print("Usage: python data_retriever.quote_retriever.py <symbol> <yyyy-MM-dd> <yyyy-MM-dd> </path/to/folder>")
        sys.exit(1)
